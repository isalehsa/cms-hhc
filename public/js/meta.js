...
// الموجتان تابعتان للشركة (منتقلتان)، ويُميَّز بينهما باللون في التقارير
export const CLUSTER_WAVES = {
  ONE: { label: "الموجة الأولى — تابعة للشركة", short: "الموجة الأولى", tone: "good", color: "#0ca30c", desc: "تجمعات الموجة الأولى المنتقلة للشركة" },
  TWO: { label: "الموجة الثانية — تابعة للشركة", short: "الموجة الثانية", tone: "good", color: "#2a78d6", desc: "تجمعات الموجة الثانية المنتقلة للشركة" },
};
